  ...
  return (
    <section className="max-container">
      <h1 className='head-text'>Hello, I'm
        <span className='blue-gradient_text font-semibold drop-shadow'> Shippu</span>
      </h1>
      ...
      <div className='py-16'>
        ...
        <div className='mt-5 flex flex-col gap-3 text-slate-500'>
          <p>I'm Working at Learn with Fraternity Pvt Ltd. leveling up my skills and teaming up with smart people. Here's the rundown:</p>
        </div>
